...
def undo():
     ...
     edit_menu.entryconfig("Undo", state="disabled")  # Disable Undo after using
...
def redo():
     ...
     edit_menu.entryconfig("Redo", state="disable") # Disable redo after using
...
file_menu.add_command(label="New File",command=New_file) #Adds the "Open" command to the File menu
...
Open_menu=tk.Menu(file_menu,tearoff=0)#creating submenu file menu than creating submenu of open recent
...
edit_menu.add_command(label="cut",command=cut)#Adds the "cut" command to the Edit menu
edit_menu.add_command(label="Copy",command=copy)
edit_menu.add_separator()
#Dybamic menu in undo,redo
edit_menu.add_command(label="Undo",command=undo, state="normal")
edit_menu.add_command(label="Redo",command=redo, state="disable")
...
help_option=tk.Menu(help_menu,tearoff=0)#creation ..... submenu name Help than creation submenu of Help named Welcome,All Command)
